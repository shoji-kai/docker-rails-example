...
**This app is using Rails 8.1.2 and Ruby 4.0.1**. The screenshot shows
...
```sh
git clone https://github.com/nickjj/docker-rails-example ecommerce
cd ecommerce
```
...
The app is named `ecommerce` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "ecommerce" and update a few Docker related resources.
